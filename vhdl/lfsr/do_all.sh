...
/home/dominik/intelFPGA/20.1/modelsim_ase/bin/vcom -explicit -2008 $(dirname  ${BASH_SOURCE[0]})/src/lfsr.vhdl     -work ./work

if [ "$1" = "-tb" ];
then
	/home/dominik/intelFPGA/20.1/modelsim_ase/bin/vcom -explicit -2008 $(dirname  ${BASH_SOURCE[0]})/test/tb_lfsr.vhdl     -work ./work
