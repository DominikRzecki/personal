...
/home/dominik/intelFPGA/20.1/modelsim_ase/bin/vcom -explicit -2008 $(dirname  ${BASH_SOURCE[0]})/src/WS2812.vhd     -work ./work

if [ "$1" = "-tb" ];
then
/home/dominik/intelFPGA/20.1/modelsim_ase/bin/vcom -explicit -2008 $(dirname  ${BASH_SOURCE[0]})/test/tb_WS2812.vhd     -work ./work
fi
