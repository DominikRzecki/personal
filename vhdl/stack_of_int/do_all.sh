...
/home/dominik/intelFPGA/20.1/modelsim_ase/bin/vcom -explicit -93 $(dirname  ${BASH_SOURCE[0]})/src/stack_of_int.vhd     -work ./work

if [ "$1" = "-tb" ];
then
	/home/dominik/intelFPGA/20.1/modelsim_ase/bin/vcom -explicit -93 $(dirname  ${BASH_SOURCE[0]})/test/tb_stack_of_int.vhd     -work ./work
fi
